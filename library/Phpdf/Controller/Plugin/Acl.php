...
class Phpdf_Controller_Plugin_Acl extends Zend_Controller_Plugin_Abstract {
    ...
    protected function getAcl() {
        ...
        $oAcl->add(new Zend_Acl_Resource('administrador:editar-participante'));

        $oAcl->add(new Zend_Acl_Resource('salas:index'));
        $oAcl->add(new Zend_Acl_Resource('salas:formulario'));
        $oAcl->add(new Zend_Acl_Resource('salas:delete'));
		...
		$oAcl->add(new Zend_Acl_Resource('participantes:ficha-participante'));
        $oAcl->add(new Zend_Acl_Resource('participantes:certificado'));
        $oAcl->add(new Zend_Acl_Resource('participantes:code_certificado'));
        ...
        $oAcl->add(new Zend_Acl_Resource('participantes:editar-participante'));
		...
		$oAcl->add(new Zend_Acl_Resource('presencas:index'));
        $oAcl->add(new Zend_Acl_Resource('presencas:pesquisa_participante'));
        $oAcl->add(new Zend_Acl_Resource('presencas:grava_presenca'));
	$oAcl->add(new Zend_Acl_Resource('presencas:code_participante'));
        ...
        $oAcl->allow('all', 'participantes:code_certificado');
        ...
        $oAcl->allow('participante', 'participantes:editar-participante');
		$oAcl->allow('participante', 'participantes:ficha-participante');
        ...
        $oAcl->allow('admin', 'administrador:editar-participante');

        $oAcl->allow('admin', 'presencas:index');
        $oAcl->allow('admin', 'presencas:pesquisa_participante');
        $oAcl->allow('admin', 'presencas:grava_presenca');
        $oAcl->allow('admin', 'presencas:code_participante');

...
class AtividadesController extends Phpdf_Controller_Action
{
    ...
    public function visualizarAction()
    {
        ...
        if ($id !== false) {
            ...
            $this->view->row                     = $rowAtividade;
            $select = $rowAtividade->select()->order(array('nome ASC'));
            $this->view->participantes            = $rowAtividade->findManyToManyRowset('Usuario','Inscricao', NULL, NULL, $select);
